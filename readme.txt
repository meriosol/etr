...
3. Folders overview
 3.1. configs: Backend configs.  
       ...
       - javadb_sample_runtime: JavaDB(apache derby) runtime folder. 
	                            It can be copied somewhere outside this code tree and used as foundation for sample database (eventium).
